...
public class ShareActivity extends AppCompatActivity {
    ...
    private final CollectionReference shareReference = database.collection(ReferenceConstant.SHARE);
            ...
            uploadTask.continueWithTask((task) -> {
                ...
                if (task.isSuccessful() & task.getResult() != null) {
                    ...
                    if (!Helper.isNullOrBlank(post.getType()) && post.getType().equals(Constants.IMAGE_TYPE)) {
                        ...
                        shareReference.document(post.getId()).set(post);

                        Toast.makeText(ShareActivity.this, "Image Uploaded", Toast.LENGTH_SHORT).show();
                        finish();

                    } else {
                        Toast.makeText(ShareActivity.this, "Error: Unknown Type", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        } else {
